    ...
    <div className="header-section">
      <section className="top-navbar">
        ...
        <div className="login-info">
          {user?.email ? (
            <h5><BsFillPersonLinesFill className="person-icon" style={{color:"yellowgreen ",fontSize:"2.5rem"}}/> <span style={{color:"black",display:"inline-block",fontSize:"1.5rem",verticalAlign:"middle"}}>{user.displayName}</span></h5>
          ) : (
            <h4 style={{ color: "crimson" }}>Welcome To Our Website</h4>
          )}
        </div>
        {user?.email ?<>
